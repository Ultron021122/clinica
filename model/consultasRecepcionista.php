<?php
    ...
    switch ($tipo_consulta) {
        ...
        case 'editar':
            $ID = $_POST['id'];
            $consultas = new recepcionista();
            $ejecutar = $consultas->search_registro($ID);
            echo json_encode($ejecutar);
            break;
        case 'update':
            $ID                 = $_POST["ID"];
            ...
            $Email              = $_POST['Email'];
            $consultas = new recepcionista();
            $ejecutar = $consultas->modificar_registro($ID, strtoupper($CURP), $Nombre, $Apellidos, $Sexo, $Fecha_nacimiento, $Direccion, $Telefono, $Email, $Fecha_contratacion);
            echo json_encode($ejecutar);
            break;
        case 'eliminar':
            $ID = $_POST['id'];
