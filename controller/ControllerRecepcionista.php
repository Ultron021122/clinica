<?php
    ...
    class recepcionista extends connection {
        ...
        public function search_registro($ID) {
        ...
        public function modificar_registro($ID, $Curp, $Nombre, $Apellidos, $Sexo, $Fecha_nacimiento, $Direccion, $Telefono, $Email, $Fecha_contratacion){
            $sql = "UPDATE recepcionista SET CURP='$Curp', Nombre='$Nombre', Apellidos='$Apellidos', Sexo='$Sexo', Fecha_nacimiento='$Fecha_nacimiento', Direccion='$Direccion', Telefono='$Telefono', Email='$Email', Fecha_contratacion='$Fecha_contratacion' WHERE ID = '$ID'";    
